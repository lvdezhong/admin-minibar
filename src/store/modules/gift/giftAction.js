...
export const getGift = (params) => ({
    type: types.GET_GIFT,
    payload: api.post('/minibar/manager/item/gift_group/list', {
        params
    })
})
...
export const deleteGift = (params) => ({
    ...
    payload: api.post('/minibar/manager/item/gift_group/delete', {
        params
    })
})
...
export const getCurrentGift = (params) => ({
    ...
    payload: api.get('/minibar/manager/item/gift_group/get', {
        params
    })
})
...
export const addGift = (params) => ({
    type: types.ADD_GIFT,
    payload: api.post('/minibar/manager/item/gift_group/add', {
        params
    })
})
...
export const updateGift = (params) => ({
    ...
    payload: api.post('/minibar/manager/item/gift_group/update', {
        params
    })
})
